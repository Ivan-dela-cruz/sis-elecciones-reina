    ...
    <section class="home-about-area section-gap py-1">
        ...
        <div class="align-content-xl-center">
            <div class="comment-form" style="background-color:#04091e">
                <h3 class="text-white" >Calificación pregunta final</h3>
                <form  method="post" action="{{route('calificar-pregunta')}}">
                    {{ csrf_field() }}
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="menu-content pb-10 col-lg-4">
                            <div class="title text-center">
                                ...
                                <br>
                                <input style="height: 60px; font-size: 50px; text-align: center;" min="1" max="50"
                                       type="number" class="form-control font-weight-bold"
                                       name="pregunta" id="pregunta" required>
                            </div>
                        </div>
                    </div>
